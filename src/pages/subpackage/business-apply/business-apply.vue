                            ...
                            <template #default>
                                <view>
                                    ...
                                    <view class="form-radio-group">
                                        <uv-radio-group v-model="model.business.reason" @change="onRadioChange">
                                            <uv-radio activeColor="#27a597" name="1" label="送货"></uv-radio>
                                            <uv-radio activeColor="#27a597" name="2" label="领料"></uv-radio>
                                        </uv-radio-group>
                                    </view>
                                </view>
                            </template>
                        </uv-form-item>
                        <uv-form-item prop="business.oddNumber" borderBottom >
                            <template #default>
                                <view>
                                    <view class="form-label">
                                        <text>{{labelTextFromReason}}</text>
                                        <text class="label-required">*</text>
                                    </view>
                                    <uv-input v-model="model.business.oddNumber" placeholder="请输入" border="none"></uv-input>
                                </view>
                            </template>
                        </uv-form-item>
...
import ApplyDetails from "@/components/apply-details.vue";
...
const selectTime = ()=>{
    forward('selectTime',{key:'selectTimeForBusiness'})
    uni.$on('selectTimeForBusiness',(data)=>{
